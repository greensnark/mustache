...
func (tmpl *Template) parsePartial(name string) (*Template, error) {
	...
	for _, name := range filenames {
		...
		partial, err := ParseString(string(bytes))
		if err != nil {
			return nil, err
		}
		return partial, nil
...
func ParseStringFS(data string, filename string, filesystem Filesystem) (*Template, error) {
...
func ParseString(data string) (*Template, error) {
	cwd := os.Getenv("CWD")
	return ParseStringFS(data, cwd, DirectFS)
}
...
func ParseFile(filename string) (*Template, error) {
	...
	return ParseStringFS(string(data), dirname, DirectFS)
}
...
// RenderStringFS renders the template string, looking up partials using the
// supplied filesystem.
func RenderStringFS(template string, filesystem Filesystem, context ...interface{}) string {
	tmpl, err := ParseStringFS(template, "", filesystem)
	if err != nil {
		return err.Error()
	}
	return tmpl.Render(context...)
...
// current directory.
var DirectFS = ReadFileFunc(directFSReadFile)
